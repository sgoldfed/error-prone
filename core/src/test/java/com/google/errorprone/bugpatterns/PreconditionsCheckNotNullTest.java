...
public class PreconditionsCheckNotNullTest {
  ...
  public void testPositiveCase1() throws Exception {
    compilationHelper.assertCompileFailsWithMessages(
        fileFromResource(getClass(), "PreconditionsCheckNotNullPositiveCase1.java"));
  }

  @Test
  public void testPositiveCase2() throws Exception {
    compilationHelper.assertCompileFailsWithMessages(
        fileFromResource(getClass(), "PreconditionsCheckNotNullPositiveCase2.java"));
  }

  @Test
  public void testPositiveCase3() throws Exception {
    compilationHelper.assertCompileFailsWithMessages(
        fileFromResource(getClass(), "PreconditionsCheckNotNullPositiveCase3.java"));
  }

  @Test
  public void testNegativeCase1() throws Exception {
    compilationHelper.assertCompileSucceeds(
        fileFromResource(getClass(), "PreconditionsCheckNotNullNegativeCase1.java"));
  }

  @Test
  public void testNegativeCase2() throws Exception {
    compilationHelper.assertCompileSucceeds(
        fileFromResource(getClass(), "PreconditionsCheckNotNullNegativeCase2.java"));
  }
