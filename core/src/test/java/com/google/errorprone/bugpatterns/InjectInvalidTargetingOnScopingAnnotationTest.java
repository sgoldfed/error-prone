...
public class InjectInvalidTargetingOnScopingAnnotationTest {
  ...
  public void testPositiveCase() throws Exception {
    compilationHelper.assertCompileFailsWithMessages(fileFromResource(
        getClass(), "InjectInvalidTargetingOnScopingAnnotationPositiveCases.java"));
  }

  @Test
  public void testNegativeCase() throws Exception {
    fileFromResource(getClass(), "InjectInvalidTargetingOnScopingAnnotationNegativeCases.java");
  }
}
