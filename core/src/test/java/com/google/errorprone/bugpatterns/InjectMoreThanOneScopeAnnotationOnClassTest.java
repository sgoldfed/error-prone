...
public class InjectMoreThanOneScopeAnnotationOnClassTest {
  ...
  public void testPositiveCase() throws Exception {
    compilationHelper.assertCompileFailsWithMessages(
        fileFromResource(getClass(), "InjectMoreThanOneScopeAnnotationOnClassPositiveCases.java"));
  }

  @Test
  public void testNegativeCase() throws Exception {
    compilationHelper.assertCompileSucceeds(
        fileFromResource(getClass(), "InjectMoreThanOneScopeAnnotationOnClassNegativeCases.java"));
  }
}
