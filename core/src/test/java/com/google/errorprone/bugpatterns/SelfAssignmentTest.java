...
public class SelfAssignmentTest {
  ...
  public void testPositiveCases1() throws Exception {
    compilationHelper.assertCompileFailsWithMessages(
        fileFromResource(getClass(), "SelfAssignmentPositiveCases1.java"));
  }

  @Test
  public void testPositiveCases2() throws Exception {
    compilationHelper.assertCompileFailsWithMessages(
        fileFromResource(getClass(), "SelfAssignmentPositiveCases2.java"));
  }

  @Test
  public void testNegativeCase() throws Exception {
    compilationHelper.assertCompileSucceeds(
        fileFromResource(getClass(), "SelfAssignmentNegativeCases.java"));
  }
}