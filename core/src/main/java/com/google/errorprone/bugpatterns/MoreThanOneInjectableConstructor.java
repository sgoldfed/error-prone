...
@BugPattern(name = "MoreThanOneInjectableConstructor",
    ...
    explanation = "Having more than one injectable constructor will throw a runtime error"
        + " in compliant JSR-330 frameworks such as Guice or Dagger", 
        category = INJECT, severity = ERROR, maturity = EXPERIMENTAL)
public class MoreThanOneInjectableConstructor extends DescribingMatcher<MethodTree> {
  ...
  public static class Scanner extends com.google.errorprone.Scanner {
    public DescribingMatcher<MethodTree> methodMatcher =
        new MoreThanOneInjectableConstructor();
