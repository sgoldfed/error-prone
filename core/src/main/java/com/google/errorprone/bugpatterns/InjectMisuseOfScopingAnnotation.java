...
@BugPattern(name = "InjectMisuseOfScopingAnnotation",
    summary = "Scoping annotations are only allowed on @Provides methods or classes.", explanation =
        "Scoping annotations are only allowed on @Provides methods or classes. Perhaps "
        + "you meant to use a  @Qualifier annotation. ", category = INJECT, severity = ERROR,
